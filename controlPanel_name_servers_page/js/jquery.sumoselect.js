            ...
            this.sumo = {
                ...
                createElems: function () {
                   ...
                   var test = options;
                    ...
                    // } else {
                        // O.E.wrap('<div class="SumoSelect" style="width:70px;margin-left:7px;" tabindex="0" role="button" aria-expanded="false">');
                    // }
                    
                    O.select = O.E.parent();
                    // if(test ==1) {
                        O.caption = $('<span id="selectdata">');
                    // } else {
                        // O.caption = $('<span id="daydata">');
                    // }
